...
import static com.ekwateur.energybilling.common.fixtures.EnergyTypeFixture.PRO_CUSTOMER_WITH_REVENUE_HIGHER_THAN_ONE_MILLION;
import static com.ekwateur.energybilling.common.fixtures.EnergyTypeFixture.PRO_CUSTOMER_WITH_REVENUE_LOWER_THAN_ONE_MILLION;
...
import com.ekwateur.energybilling.common.fixtures.EnergyTypeFixture;
    ...
    public static List<BillingServiceScenario> billingServiceScenarios() {
        ...
        return List.of(
                BillingServiceScenario.builder()
                                      ...
                                      .startDate(EnergyTypeFixture.START_DATE)
                                      .endDate(EnergyTypeFixture.END_DATE)
    ...
    public static List<BillingApiScenario> billingApiErrorScenarios() {
        ...
        return List.of(
                ...
                BillingApiScenario.builder()
                                  ...
                                  .consumptionRange(ConsumptionRange.builder()
                                                                    .startDate(EnergyTypeFixture.END_DATE)
                                                                    .endDate(EnergyTypeFixture.START_DATE)
                                                                    .build())
                                  .customerReference(PRO_CUSTOMER_WITH_REVENUE_HIGHER_THAN_ONE_MILLION.getReference())
                                  .customer(null)
                                  .expectedHttpStatus(HttpStatus.BAD_REQUEST)
