...
import com.ekwateur.energybilling.common.assertions.Assertions;
...
class BillingControllerIntegrationTest {
    ...
    private static final String URL_TEMPLATE = "/bills/{customerReference}?startDate={startDate}&endDate={endDate}";
