package com.ekwateur.enengybilling.model.methodsources;
...
import com.ekwateur.enengybilling.model.energy.fixtures.EnergyTypeFixture;
...
public class EnergyTypeMethodSources {
    ...
    public static List<EnergyTypeScenario> energyTypeScenarios() {
        ...
        List<EnergyTypeScenario> energyTypeScenarios = new ArrayList<>(electricityScenarios());
        energyTypeScenarios.addAll(gasScenarios());
        return energyTypeScenarios;
    }
